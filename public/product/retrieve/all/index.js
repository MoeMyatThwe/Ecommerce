...
//                     return {
//                         productId: parseInt(checkbox.dataset.productId), // Retrieve productId from data attribute
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    .then(function (body) {
        ...
        products.forEach(function (product) {
            const row = document.createElement("tr");
            row.classList.add("product");
            row.dataset.productId = product.id; // Associate productId with the row

            const checkboxCell = document.createElement("td");
            const checkbox = document.createElement("input");
            checkbox.type = "checkbox";
            checkbox.classList.add("select-product-item");
            checkbox.dataset.productId = product.id; // Store productId in a data attribute of the checkbox
            checkboxCell.appendChild(checkbox);
